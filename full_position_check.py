"""Check all exchange positions + close any that are NOT in DB"""
import paramiko, sys
...
with open('_full_check.py', 'w', encoding='utf-8') as f:
    f.write(helper)
with SCPClient(ssh.get_transport()) as scp:
    scp.put('_full_check.py', '/tmp/_full_check.py')

out = run("cd /root/OPTION-BUYING && python3 /tmp/_full_check.py", wait=30)
print(out)
ssh.close()
