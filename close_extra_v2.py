"""Close extra BTC option position — run directly on VPS"""
import paramiko, sys
...
# Write a clean helper script to VPS
helper = """\
...
# Upload and run
with open('_close_vps.py', 'w', encoding='utf-8') as f:
    f.write(helper)
with SCPClient(ssh.get_transport()) as scp:
    scp.put('_close_vps.py', '/tmp/_close_vps.py')
print("Uploaded. Running...")

out = run("cd /root/OPTION-BUYING && python3 /tmp/_close_vps.py", wait=30)
print(out)
ssh.close()
